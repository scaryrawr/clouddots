...
fish --command="curl -sL https://raw.githubusercontent.com/jorgebucaran/fisher/main/functions/fisher.fish | source && fisher install jorgebucaran/fisher jorgebucaran/spark.fish ilancosman/tide@v6 kidonng/zoxide.fish jorgebucaran/autopair.fish franciscolourenco/done fabioantunes/base16-fish-shell patrickf1/fzf.fish scaryrawr/fish-eza </dev/null"
