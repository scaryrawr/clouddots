...
fish --command="command -q tmux && fisher install scaryrawr/tmux.fish </dev/null && set -Ux TMUX_POWERLINE_BUBBLE_SEPARATORS true && set -Ux TMUX_AUTOSTART true"
fish --command="fisher install scaryrawr/codespace-nvm.fish </dev/null"
