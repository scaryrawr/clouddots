...
fish --command="curl -sL https://raw.githubusercontent.com/jorgebucaran/fisher/main/functions/fisher.fish | source && fisher install jorgebucaran/fisher ilancosman/tide@v6 kidonng/zoxide.fish jorgebucaran/autopair.fish fabioantunes/base16-fish-shell patrickf1/fzf.fish scaryrawr/fish-eza </dev/null"
