...
- **Homebrew**: Installs development tools including fzf, eza, zoxide, ripgrep, chafa, bat, fd, git-delta, tmux, helix, neovim, lazygit, marksman, copilot-cli, worktrunk, and sl.
...
- **AI tools**: copilot-cli (via Homebrew), construct (via Bun)
