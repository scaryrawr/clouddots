...
npm install -g typescript typescript-language-server vscode-langservers-extracted pyright @typescript/native-preview prettier yaml-language-server markdownlint-cli2
